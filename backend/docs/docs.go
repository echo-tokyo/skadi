    ...
    "paths": {
        ...
        "/admin/user/{id}": {
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "неподдерживаемые данные для роли обновляемого пользователя"
                    },
                    "401": {
                        "description": "неверный токен (пустой, истекший или неверный формат)"
                    },
        ...
        "/teacher/task": {
            ...
            "post": {
                ...
                "operationId": "teacher-task-create",
                "parameters": [
                    {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "преподаватель не найден ErrNotFoundUser"
                    },
                    "401": {
                        "description": "неверный токен (пустой, истекший или неверный формат)"
                    }
